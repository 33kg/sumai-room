<ul class="detail-more2">
		<li><span>向き</span><?php FudoUtil::muki( $post_id ); ?></li>
		<li><span>現状</span><?php FudoUtil::genkyou( $post_id ); ?></li>
		<li><span>保証料</span><?php FudoUtil::hosyoukin( $post_id ); ?></li>
		<li><span>更新料</span><?php FudoUtil::koushinryou( $post_id ); ?></li>
		<li><span>引き渡し</span><?php FudoUtil::hikiwatasi_jiki( $post_id ); ?></li>
		<li><span>面積</span><?php FudoUtil::menseki( $post_id ); ?></li>
		<li><span>駐車場区分</span><?php FudoUtil::tyuusyajo_kubun( $post_id ); ?></li>
		<li><span>駐車料金</span><?php FudoUtil::tyuusyajo_ryoukin( $post_id ); ?></li>
		<li><span>小学校</span><?php FudoUtil::syougakkou( $post_id ); ?></li>
		<li><span>中学校</span><?php FudoUtil::tyuugakkou( $post_id ); ?></li>
		</ul>
